const textConfig = {
  ...
  text8: "Okei <3",
  text9: "............",
  text10: "Canda2, text tadi gbisa kk baca wkwk",
  text11:
    "ini stelah angel klik tombol dibawah bakal dibawa ke ig kk, paste di chat kk jha",
  text12: "Okii hunn X)",
};
...
$(document).ready(function () {
  ...
  $("#yes").click(function () {
    ...
    Swal.fire({
      ...
      width: 900,
      padding: "3em",
      html: "<input type='text' class='form-control' id='txtReason'  placeholder='ketik textnya, jangan lupa di copy dulu yaw'>",
      background: '#fff url("img/iput-bg.jpg")',
      backdrop: `
                    rgba(0,0,123,0.4)
                    url("img/giphy2.gif")
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.instagram.com/ryan_hb13/";
          },
        });
      }
    });
